...
call <SID>AddAlternateExtensionMapping('h',"c,C,cpp,cxx,cc,CC,m,M,mm,MM")
call <SID>AddAlternateExtensionMapping('H',"c,C,CPP,CXX,cc,CC,m,M,mm,MM")
...
if (!exists('g:alternateSearchPath'))
        let g:alternateSearchPath = 'sfr:./source,sfr:./src,sfr:../source,sfr:../src'
        let g:alternateSearchPath .= ',sfr:./include,sfr:./inc,sfr:../include,sfr:../inc'
endif
